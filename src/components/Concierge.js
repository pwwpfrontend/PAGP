...
const Concierge = () => {
  ...
  "Sydney": "PAG-33F-SYDNEY", // Not found in JSON
  "Delhi": "PAG-33F-DELHI",     // Not found in JSON 
  "London": "PAG-33F-LONDON",   // Not found in JSON 
  "Tokyo": "Tokyo",            
  "Hong Kong": "PAG-33F-HONGKONG", // Not found 
  "Singapore": "PAG-33F-SINGAPORE", // Not found 
  "New York": "PAG-33F-NEWYORK", // Not found 
  "Seoul": "PAG-33F-SEOUL" // Not found 
};
...
const isAvailable = (label) => {
  ...
  if (!mapped || mapped.length === 0) return true; // Default to available
